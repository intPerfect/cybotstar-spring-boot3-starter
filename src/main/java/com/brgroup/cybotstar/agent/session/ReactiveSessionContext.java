...
public class ReactiveSessionContext {
    ...
    @NonNull
    private final ReactiveWebSocketConnection connection;
    ...
    public ReactiveSessionContext(
            @NonNull String sessionId,
            @NonNull ReactiveWebSocketConnection connection) {
     ...
     */
    @NonNull
    public ReactiveWebSocketConnection getConnection() {
        return connection;
    }
